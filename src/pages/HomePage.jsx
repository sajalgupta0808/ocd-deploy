    ...
    return (
        <div className="mx-auto">
            ...
            <section className='text-app-white relative min-h-screen overflow-hidden'>
                ...
                <div>
                    <p className='font-semibold text-md text-gray-300 text-center mt-4 xl:mt-3'>
                    Premium PPF, ceramic and graphene coatings for your ride. Handled personally by the <br /> 
                    founders. No Compromises. Only perfection.
                    </p>
                </div>

                <div>
                    <button className='bg-custom-red border-custom-red text-white font-bold px-8 py-2 text-lg border-2 rounded-md'>
            ...
            <section className='py-16 flex flex-col items-center justify-center gap-8'>
              ...
              <div className='max-w-7xl mx-auto px-8'>
                    ...
                    <div className='flex justify-center gap-8'>
                        <div className='relative flex-1 max-w-xs'>
                            <img src={f5} alt="Background 5" className='w-full h-auto rounded-lg' />
                        </div>
                        <div className='relative flex-1 max-w-xs'>
                            <img src={f6} alt="Background 6" className='w-full h-auto rounded-lg' />
                        </div>
                        <div className='relative flex-1 max-w-xs'>
                            <img src={f7} alt="Background 7" className='w-full h-auto rounded-lg' />
                        </div>
                    </div>
                </div>
            </section>
